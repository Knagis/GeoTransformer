...
{
    /// <summary>
    /// ComboBox extended with the ability to select multiple items using check boxes.
    /// </summary>
    public class CheckedComboBox : ComboBox
    {
        ...
        private void DoDropDown()
        {
            if (!dropdown.Visible)
            {
                ...
                dropdown.Size = new Size(this.DropDownWidth, (dropdown.List.ItemHeight) * count + 2);
                dropdown.Show(this);
            }
        }
