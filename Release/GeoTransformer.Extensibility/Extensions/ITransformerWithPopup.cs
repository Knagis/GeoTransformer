...
namespace GeoTransformer.Extensions
{
    ...
    /// As the transformers are executed on a background thread, such operation requires the UI code to be executed using <see cref="System.Windows.Forms.Control.Invoke(System.Delegate)"/> method
