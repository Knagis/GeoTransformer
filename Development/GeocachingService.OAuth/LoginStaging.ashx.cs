...
namespace GeocachingService.OAuth
{
    ...
    /// </summary>
    public class LoginStaging : IHttpHandler
    {
        /// <summary>
        /// The end-point for the OAuth service.
        /// </summary>
        private static DotNetOpenAuth.Messaging.MessageReceivingEndpoint OAuthEndPoint = 
            new DotNetOpenAuth.Messaging.MessageReceivingEndpoint("https://staging.geocaching.com/OAuth/oauth.ashx", DotNetOpenAuth.Messaging.HttpDeliveryMethods.PostRequest);
        ...
        /// <summary>
        /// The token manager for the staging service.
        /// </summary>
        private static TokenManager TokenManager = new TokenManager(LiveApiKeys.StagingKey, LiveApiKeys.StagingSecret);
